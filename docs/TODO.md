...
>
> 최종 업데이트: 2026-07-11 (CueList 항목 텍스트 잘림 개선 완료, 9-37 —
> `.cue-preview`에 native `title` 툴팁 추가, 원래 계획대로 착수. 이전:
> CueList/"초기화" 버튼의 잔존 `confirm()` 제거(9-36, 신규 발견), Auto
> Advance P3 보류, 스타일 프리셋 업데이트(덮어쓰기)·Transition
