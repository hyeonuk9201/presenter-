...
>
> 최종 업데이트: 2026-07-24 (main/bus 라우팅 Research 초안 작성 —
...
- [x] **MediaRuntimeCache blob URL 미축출 — evict() 호출부 0곳 (런타임 누수)** — 2026-07-23에서 완료(D-0001)
  - Priority(당시): P3 · Status: 완료 · Reason: 2026-07-16 탐색에서 코드로
    ...
    둘 다 CommandBus 내부)으로 통제. output.html 자체 캐시/IndexedDB 영속
    GC/LRU는 Non-goal(D-0001) · Completion Criteria: 회귀 테스트 23건
