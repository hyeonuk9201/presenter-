...
>
> 최종 업데이트: 2026-07-12 (UI 통지 이행(TD-4) 완료 확인 + 사후 기록,
...
- **Live Emergency Overlay (MVP)** — Research 탐구(9-44)에서 승격.
  ...
  [Feature TODO](#feature-todo) 참조. 선행 가치였던 UI 통지 이행이
  9-46에서 완료 확인됨 — Overlay 구독은 처음부터
  `interestedMutations` 경로로 설계하면 된다.
